# -*- coding: utf-8 -*-
# !/usr/bin/env python3
""" The script is the original FID implementation by Heusel et al. NeurIPS 2017.
...
def _get_inception_layer(sess):
    """ Note from LAGAN-repo: this code can be problematic for different tf versions,
        if issues, we advise trying out with the commented-out lines containing `[...]`
...
def get_activations(images, sess, batch_size=100, verbose=True):
